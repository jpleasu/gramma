...
PrintableChar := ['a'..'z']|EscapedSpace ;
PrintableCharNoDquote := ['a'..'z']|EscapedSpace ;
PrintableCharNoBackslash := ['a'..'z']|EscapedSpace ;
EscapedSpace := '""' ;
#WhiteSpaceChar := '\u0009'|'\u000A'|'\u000D'|'\u0020' ;
WhiteSpaceChar := ' ';
...
s_expr2 := spec_constant|0 symbol|0 keyword| `exprrec` ParOpen.s_expr2{0,`maxrep`}.ParClose ;
