...
got_expected(AnalyzeMeGrammar4, 'uses', ','.join(sorted(g.funcdefs['f'].meta.statevar_uses)),
             'mod,obj1,obj3,subscript_mod,subscript_mod2,subscript_use,used')
got_expected(AnalyzeMeGrammar4, 'defs', ','.join(sorted(g.funcdefs['f'].meta.statevar_defs)),
             'assigned,mod,obj1,obj2,obj3,subscript_def,subscript_mod,subscript_mod2')
