...
# add a dummy to get past line in generated code (ANTLRv4LexerPythonTarget.py) which is broken with python
# package qualification:
#   from LexerAdaptor import LexerAdaptor
dummy = types.ModuleType('LexerAdaptor')
dummy.LexerAdaptor = None  # type: ignore
sys.modules['LexerAdaptor'] = dummy
...
class TransformingVisitor(antlr4.ParseTreeVisitor):
    ...
    def visitAlternative(self, alt):
        ...
        if alt.elementOptions() is not None:
